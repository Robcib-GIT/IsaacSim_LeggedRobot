...
asset_path = "/home/robcib/Desktop/Jorge/My_World_Terreno_Nuevo.usd" #assets_root_path + "/Isaac/Environments/Grid/default_environment.usd"
...
waypoints = [
    np.array([3.50, -2.50, 0.00]),  # Waypoint 1
    np.array([2.86, -2.64, 10.00]),  # Waypoint 2
    np.array([1.99, -2.64, 20.00]),  # Waypoint 3
    np.array([1.49, -2.44, 20.00]),  # Waypoint 4
    np.array([1.19, -2.21, 10.00]),  # Waypoint 5
    np.array([0.79, -2.21, 10.00]),  # Waypoint 6
    np.array([0.59, -2.11, 10.00]),  # Waypoint 7
    np.array([0.39, -2.11, 10.00]),  # Waypoint 8
    np.array([-0.01, -2.31, 10.00]),  # Waypoint 9
    np.array([-0.31, -2.21, 10.00]),  # Waypoint 10
    np.array([-0.81, -2.11, 20.00]),  # Waypoint 11
    np.array([-1.71, -1.11, 40.00]),  # Waypoint 12
    np.array([-1.71, -0.71, 70.00]),  # Waypoint 13
    np.array([-1.71, -0.71, 85.00]),  # Waypoint 14
    np.array([-1.91, -0.21, 85.00]),  # Waypoint 15
    np.array([-1.91, 0.19, 90.00]),  # Waypoint 16
    np.array([-1.84, 0.36, 90.00]),  # Waypoint 17
    np.array([-1.84, 0.36, 120.00]),  # Waypoint 18
    np.array([-1.74, 0.41, 140.00]),  # Waypoint 19
    np.array([-1.74, 0.41, 160.00]),  # Waypoint 20
    np.array([-1.54, 0.41, 170.00]),  # Waypoint 21
    np.array([-1.14, 0.46, 175.00]),  # Waypoint 22
    np.array([-0.64, 0.66, 175.00]),  # Waypoint 23
    np.array([0.36, 0.86, 175.00]),  # Waypoint 24
    np.array([1.36, 0.86, 175.00]),  # Waypoint 25
    np.array([1.86, 0.86, 175.00]),  # Waypoint 26
    np.array([2.07, 0.87, 175.00]),  # Waypoint 27
]
og.Controller.edit(
