...
sensor = EffortSensor(
prim_path="/World/Spot/FL_hip/FL_thigh_joint",
sensor_period=10,
use_latest_data=False,
enabled=True)

sensor_2 = EffortSensor(
prim_path="/World/Spot/FR_hip/FR_thigh_joint",
sensor_period=10,
use_latest_data=False,
enabled=True)

sensor_3 = EffortSensor(
prim_path="/World/Spot/RL_hip/RL_thigh_joint",
sensor_period=10,
use_latest_data=False,
enabled=True)

sensor_4 = EffortSensor(
prim_path="/World/Spot/RR_hip/RR_thigh_joint",
sensor_period=10,
use_latest_data=False,
enabled=True)
