...
#Punto_actual = [2, 0,0]
#Way_Point = [3, 2,20]
#diferencia_x = Way_Point[0] - Punto_actual[0]
#diferencia_y = Way_Point[1] - Punto_actual[1]
#diferencia_theta = Way_Point[2] - Punto_actual[2]
...
#print(f"Velocidad calculada: {velocidad_x} en el eje x y {velocidad_y} en el eje y. El ángulo de giro será de {V_giro}")
